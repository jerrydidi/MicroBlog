...
package page
{
	...
	public class SelectedPageEleven extends BaseSelectedPage {
		...
		private var answer:int = -1;
				//
		public function SelectedPageEleven(mainPage:MainPage,pageNo:int) {
			// constructor code
		...
		{	
			_mainPage.childPage = _mainPage.page11;

			answer = _mainPage.answer[9];
			checkAnswer();
