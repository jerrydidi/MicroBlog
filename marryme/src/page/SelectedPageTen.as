...
package page
{
	...
	public class SelectedPageTen extends BaseSelectedPage {
		...
		private var answer:int = -1;
				//
		public function SelectedPageTen(mainPage:MainPage,pageNo:int) {
			// constructor code
		...
		{	
			_mainPage.childPage = _mainPage.page10;

			answer = _mainPage.answer[8];
			checkAnswer();
